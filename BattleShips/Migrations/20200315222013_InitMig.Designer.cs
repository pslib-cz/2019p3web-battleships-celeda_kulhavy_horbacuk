...
namespace BattleShips.Migrations
{
    ...
    [Migration("20200315222013_InitMig")]
            ...
            modelBuilder.Entity("BattleShips.Model.Ship", b =>
                {
                    ...
                    b.Property<int?>("ShipUserPlacedShipUserId")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("ShipUserPlacedShipUserId");
            ...
            modelBuilder.Entity("BattleShips.Model.Ship", b =>
                {
                    b.HasOne("BattleShips.Model.ShipUserPlaced", null)
                        .WithMany("Ships")
                        .HasForeignKey("ShipUserPlacedShipUserId");
                });
            ...
            modelBuilder.Entity("BattleShips.Model.ShipUserPlaced", b =>
                {
                    ...
                    b.HasOne("BattleShips.Model.UserGame", null)
                        .WithMany("PlacedShips")
                        .HasForeignKey("UserGameId");
